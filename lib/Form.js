...
function (_React$PureComponent) {
  ...
  function Form(_props, _context) {
    ...
    function () {
      ...
      regeneratorRuntime.mark(function _callee(path, _ref2) {
        var props, options, abortEarly, value, schema, noPathRe, match, fieldName, _iterator, _isArray, _i, _ref4, _i2;
        ...
        return regeneratorRuntime.wrap(function _callee$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 14:
                console.log("handle When exception", _context2.t0.toString()); //The schema does not contain the path: usAddress.zip
                ...
                fieldName = match[0];
                _iterator = _this.props.touched, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();
  ...
  Form.getDerivedStateFromProps = function getDerivedStateFromProps(_ref5, _ref6) {
