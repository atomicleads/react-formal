...
function (_React$PureComponent) {
  ...
  function Form(_props, _context) {
    ...
    function () {
      ...
      regeneratorRuntime.mark(function _callee(path, _ref2) {
        var props, options, abortEarly, value, schema, res;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 11:
                ...
                console.log("SHIT CATCHED!", _context2.t0);
  ...
  _proto.handleWhenExceptions = function handleWhenExceptions(e) {
    console.log("handle When exception", e.toString()); //The schema does not contain the path: usAddress.zip

    var noPathRe = /The schema does not contain the path: ([\w\._-]+)/;
    var match = noPathRe.exec(e.toString());

    if (match != null) {
      var fieldName = match[0];

      for (var _iterator = this.props.touched, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[Symbol.iterator]();;) {
        var _ref6;
